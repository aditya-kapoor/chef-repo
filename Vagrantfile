...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "adityakapoor-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/aditya-chef-training"
  #   chef.validation_client_name = "aditya-chef-training-validator"
  #   chef.validation_key_path = ".chef/aditya-chef-training-validator.pem"
  # end
end
